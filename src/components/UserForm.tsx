...
export default function UserForm({ user, onSuccess, onCancel }: UserFormProps) {
  ...
  const [weeklyHours, setWeeklyHours] = useState(user?.weekly_hours?.toString() || "");
      ...
      {role === "user" && (
        <div className="space-y-4 border-t border-zinc-800 pt-4 mt-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-zinc-300">Designación</label>
              <input
                type="text"
                value={designation}
            ...
            <div>
              <label className="block text-sm font-medium text-zinc-300">Especialización</label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-zinc-300">Área de Trabajo</label>
              <input
                type="text"
                value={workArea}
            ...
            <div>
              <label className="block text-sm font-medium text-zinc-300">Horas Semanales</label>
              <input
                type="number"
                value={weeklyHours}
          ...
          <div>
            <label className="block text-sm font-medium text-zinc-300">Contacto</label>
            <input
              type="text"
              value={contact}
