...
export default function LoginForm({ demoAccounts, forbidden }: LoginFormProps) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 px-6 py-12">
      <div className="w-full max-w-lg rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm">
        ...
        <div className="mt-8">
          <h2 className="text-sm font-semibold text-zinc-900">Cuentas demo</h2>
              ...
              >
                ...
                {account.managerId ? (
                  <div className="mt-1 text-xs text-zinc-500">
                    Manager asignado: {account.managerId}
                  </div>
                ) : null}
              </div>
            ))}
